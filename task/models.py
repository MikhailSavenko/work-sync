...
class Evaluation(models.Model):
    ...
    score = models.PositiveSmallIntegerField(
        verbose_name="Оценка выполния задачи", validators=[MinValueValidator(1), MaxValueValidator(5)]
    )
...
class Comment(models.Model):
    ...
    task = models.ForeignKey(
        Task, verbose_name="Комментируемая задача", on_delete=models.CASCADE, related_name="comments"
    )
